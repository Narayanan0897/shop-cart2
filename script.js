const productDetails = [
{
  ...
  qty: 20,
  heading: "Bluetooth Wireless Headphones",
  des:
  "Get audio sound products like Headphones with latest technology by Samsung."
 },

{
  ...
  qty: 10,
  heading: "Galaxy Watch4 LTE (40mm)",
  des:
  "The Galaxy Watch 4 series also comes with an optical heart rate sensor (PPG), electrocardiogram (ECG), and bioelectrical impedance (BIA) sensor." },

{
  ...
  qty: 20,
  heading: "Samsung Galaxy Book S",
  des:
  "The Galaxy Book comes with either an Intel Core i5 processor or an Intel Core i7 processor. The Galaxy Book Pro 360, on the other hand, only comes with Intel Core i7 processors." },

{
  ...
  des:
  "Never miss that perfect shot again. Meet Galaxy S21 5G and S21+ 5G. Designed to revolutionize video and photography, with beyond cinematic 8K resolution." },

{
  name: "Samsung Tablet",
  price: 17999,
  imageUrl:"img/ipad.png",
  qty: 25,
  heading: "Samsung Galaxy Tab A7",
  des:
  "Samsung Galaxy Tab A7 WiFi + 4G Android Tablet (Android 10, Qualcomm Snapdragon 662, 26.41 cm (10.4)." }];
...
<div class='card'>
  ...
  <div class='details'>
    <div class='name-fav'>
     ...
     <span style="color: #ff0000;font-size:14px;" class="fa fa-star checked"></span>
     <span style="color: #ff0000;font-size:14px;" class="fa fa-star checked"></span>
     <span style="color: #ff0000;font-size:14px;" class="fa fa-star checked"></span>
     <span style="color: #ff0000;font-size:14px;" class="fa fa-star"></span>
     <span style="font-size:14px;" class="fa fa-star"></span>
    </div>
    <div class='wrapper'>
      <h5>${heading}</h5>
      <p>${des}</p>
